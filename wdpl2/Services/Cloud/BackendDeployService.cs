...
public sealed class BackendDeployService
{
    ...
    public static readonly IReadOnlyList<string> BundledFiles = new[]
    {
        "api/_captain.php",
        "api/_admin.php",
        "api/_admin_security.php",
        "api/_admin_sync_rules.php",
        ...
        "api/_entry_forms.php",
        "api/_smtp.php",
        "api/submit.php",
        "api/entry-forms/submit.php",
        "api/admin/.htaccess",
        "api/admin/audit.php",
        "api/admin/availability.php",
        "api/admin/broadcast.php",
        "api/admin/captain-account.php",
        "api/admin/captains.html",
        "api/admin/captains.php",
        "api/admin/cup.php",
        "api/admin/diag.php",
        "api/admin/email.php",
        "api/admin/entry-form-definitions.php",
        "api/admin/entry-form-submissions.php",
        "api/admin/entry-reviews.php",
        "api/admin/entry-reviews.js",
        "api/admin/export.php",
        "api/admin/fixtures.php",
        "api/admin/generate-fixtures.php",
        "api/admin/login.php",
        "api/admin/logout.php",
        "api/admin/mark-processed.php",
        "api/admin/pending.php",
        "api/admin/players.php",
        "api/admin/publish-league.php",
        "api/admin/reopen-fixture.php",
        "api/admin/scorecard-edit.php",
        "api/admin/scorecards.php",
        "api/admin/seasons.php",
