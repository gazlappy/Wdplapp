...
type
  TSingles = class(TForm)
    ...
    Single14: TTable;
    SS14: TDataSource;
    Single13MatchNo: TFloatField;
    Single13SingleNo: TFloatField;
    Single13HomePlayerName: TStringField;
    Single13AwayPlayerName: TStringField;
    Single13Winner: TStringField;
    Single13EightBall: TBooleanField;
    Single15MatchNo: TFloatField;
    Single15SingleNo: TFloatField;
    Single15HomePlayerName: TStringField;
    Single15AwayPlayerName: TStringField;
    Single15Winner: TStringField;
    Single15EightBall: TBooleanField;
    Single14MatchNo: TFloatField;
    Single14SingleNo: TFloatField;
    Single14HomePlayerName: TStringField;
    Single14AwayPlayerName: TStringField;
    Single14Winner: TStringField;
    Single14EightBall: TBooleanField;
    ...
    procedure Single13BeforePost(DataSet: TDataSet);
    procedure Single14BeforePost(DataSet: TDataSet);
    procedure Single15BeforePost(DataSet: TDataSet);
    procedure FormShow;
    ...
    procedure DBEdit25DragOver(Sender, Source: TObject; X, Y: Integer;
      State: TDragState; var Accept: Boolean);
    procedure DBEdit25DragDrop(Sender, Source: TObject; X, Y: Integer);
    procedure DBEdit25DblClick(Sender: TObject);
    procedure DBEdit27DragOver(Sender, Source: TObject; X, Y: Integer;
      State: TDragState; var Accept: Boolean);
    procedure DBEdit27DragDrop(Sender, Source: TObject; X, Y: Integer);
    procedure DBEdit27DblClick(Sender: TObject);
    procedure DBEdit29DragOver(Sender, Source: TObject; X, Y: Integer;
      State: TDragState; var Accept: Boolean);
    procedure DBEdit29DragDrop(Sender, Source: TObject; X, Y: Integer);
    ...
    procedure DBEdit26DragOver(Sender, Source: TObject; X, Y: Integer;
      State: TDragState; var Accept: Boolean);
    procedure DBEdit26DragDrop(Sender, Source: TObject; X, Y: Integer);
    procedure DBEdit26DblClick(Sender: TObject);
    procedure DBEdit28DragOver(Sender, Source: TObject; X, Y: Integer;
      State: TDragState; var Accept: Boolean);
    procedure DBEdit28DragDrop(Sender, Source: TObject; X, Y: Integer);
    procedure DBEdit28DblClick(Sender: TObject);
    procedure DBEdit30DragOver(Sender, Source: TObject; X, Y: Integer;
      State: TDragState; var Accept: Boolean);
    procedure DBEdit30DragDrop(Sender, Source: TObject; X, Y: Integer);
    procedure DBEdit30DblClick(Sender: TObject);
  ...
  public
    ...
    procedure GetSingle13;
    procedure GetSingle14;
    procedure GetSingle15;
    ...
    procedure HideSingle13;
    procedure HideSingle14;
    procedure HideSingle15;
...
procedure TSingles.Edit(MatchNo: Double; ATN, HTN: String);
begin
  LeagueQuery.Close;
  LeagueQuery.Open;
  LeagueQuery.First;
...
procedure TSingles.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Single1.Close;
  Single2.Close;
  Single3.Close;
...
function TSingles.AddToList1(RequiredName: String): Double;
begin
...
function TSingles.RemoveFromList1(RequiredName: String): Double;
begin
  if RequiredName <> '** Conceeded **' then
    ListBox1.Items.Delete(ListBox1.ItemIndex);
end;

function TSingles.AddToList2(RequiredName: String): Double;
begin
  if RequiredName <> '** Conceeded **' then
    if RequiredName <> 'Unknown' then
      if RequiredName <> '' then
...
function TSingles.RemoveFromList2(RequiredName: String): Double;
begin
  if RequiredName <> '** Conceeded **' then
    ListBox2.Items.Delete(ListBox2.ItemIndex);
end;

function TSingles.GetPlayerNo(RequiredName, RequiredTeam: String): Double;
begin
  if RequiredName = '** Conceeded **' then
  begin
    Result := 0;
...
function TSingles.GetPlayerName(RequiredNo: Double): String;
begin
...
procedure TSingles.Single1BeforePost(DataSet: TDataSet);
begin
...
procedure TSingles.Single2BeforePost(DataSet: TDataSet);
begin
...
procedure TSingles.Single3BeforePost(DataSet: TDataSet);
begin
...
procedure TSingles.Single4BeforePost(DataSet: TDataSet);
begin
...
procedure TSingles.Single5BeforePost(DataSet: TDataSet);
begin
...
procedure TSingles.Single6BeforePost(DataSet: TDataSet);
begin
...
procedure TSingles.Single7BeforePost(DataSet: TDataSet);
begin
...
procedure TSingles.Single8BeforePost(DataSet: TDataSet);
begin
...
procedure TSingles.Single9BeforePost(DataSet: TDataSet);
begin
...
procedure TSingles.Single10BeforePost(DataSet: TDataSet);
begin
...
procedure TSingles.Single11BeforePost(DataSet: TDataSet);
begin
...
procedure TSingles.Single12BeforePost(DataSet: TDataSet);
begin
...
procedure TSingles.Single13BeforePost(DataSet: TDataSet);
begin
  Single13MatchNo.Value := TMNo;
  Single13SingleNo.Value := 13;
  pno := GetPlayerNo(Single13HomePlayerName.Value,hometeam);
  Single13HomePlayerName.Value := FloatToStr(pno);
  pno := GetPlayerNo(Single13AwayPlayerName.Value,awayteam);
  Single13AwayPlayerName.Value := FloatToStr(pno);
end;
procedure TSingles.Single14BeforePost(DataSet: TDataSet);
begin
  Single14MatchNo.Value := TMNo;
  Single14SingleNo.Value := 14;
  pno := GetPlayerNo(Single14HomePlayerName.Value,hometeam);
  Single14HomePlayerName.Value := FloatToStr(pno);
  pno := GetPlayerNo(Single14AwayPlayerName.Value,awayteam);
  Single14AwayPlayerName.Value := FloatToStr(pno);
end;
procedure TSingles.Single15BeforePost(DataSet: TDataSet);
begin
  Single15MatchNo.Value := TMNo;
  Single15SingleNo.Value := 15;
  pno := GetPlayerNo(Single15HomePlayerName.Value,hometeam);
  Single15HomePlayerName.Value := FloatToStr(pno);
  pno := GetPlayerNo(Single15AwayPlayerName.Value,awayteam);
  Single15AwayPlayerName.Value := FloatToStr(pno);
end;

procedure TSingles.FormShow;
begin
  ...
  if LeagueQueryNoSingles.Value > 11 then
    ...
    HideSingle12;
  if LeagueQueryNoSingles.Value > 12 then
    GetSingle13
  else
    HideSingle13;
  if LeagueQueryNoSingles.Value > 13 then
    GetSingle14
  else
    HideSingle14;
  if LeagueQueryNoSingles.Value > 14 then
    GetSingle15
  else
    HideSingle15;
end;
...
procedure TSingles.GetSingle10;
begin
  with Single10 do
  begin
    Open;
...
procedure TSingles.GetSingle11;
begin
  with Single11 do
  begin
    Open;
...
procedure TSingles.GetSingle12;
begin
  with Single12 do
  begin
    Open;
...
procedure TSingles.GetSingle13;
begin
  with Single13 do
  begin
    Open;
    ...
    begin
      Single13.Edit;
      pno := StrToFloat(Single13HomePlayerName.Value);
      Single13HomePlayerName.Value := GetPlayerName(pno);
      RemoveHomePlayer(Single13HomePlayerName.Value);
      pno := StrToFloat(Single13AwayPlayerName.Value);
      Single13AwayPlayerName.Value := GetPlayerName(pno);
      RemoveAwayPlayer(Single13AwayPlayerName.Value);
    end
    else
    begin
      Single13.Insert;
      Single13EightBall.Value := False;
      Single13Winner.Value := 'Away';
    end;
  end;
end;

procedure TSingles.GetSingle14;
begin
  with Single14 do
  begin
    Open;
    ...
    begin
      Single14.Edit;
      pno := StrToFloat(Single14HomePlayerName.Value);
      Single14HomePlayerName.Value := GetPlayerName(pno);
      RemoveHomePlayer(Single14HomePlayerName.Value);
      pno := StrToFloat(Single14AwayPlayerName.Value);
      Single14AwayPlayerName.Value := GetPlayerName(pno);
      RemoveAwayPlayer(Single14AwayPlayerName.Value);
    end
    else
    begin
      Single14.Insert;
      Single14EightBall.Value := False;
      Single14Winner.Value := 'Away';
    end;
  end;
end;

procedure TSingles.GetSingle15;
begin
  with Single15 do
  begin
    Open;
    ...
    begin
      Single15.Edit;
      pno := StrToFloat(Single15HomePlayerName.Value);
      Single15HomePlayerName.Value := GetPlayerName(pno);
      RemoveHomePlayer(Single15HomePlayerName.Value);
      pno := StrToFloat(Single15AwayPlayerName.Value);
      Single15AwayPlayerName.Value := GetPlayerName(pno);
      RemoveAwayPlayer(Single15AwayPlayerName.Value);
    end
    else
    begin
      Single15.Insert;
      Single15EightBall.Value := False;
      Single15Winner.Value := 'Away';
    end;
  end;
end;

procedure TSingles.HideSingle1;
begin
...
procedure TSingles.HideSingle2;
begin
...
procedure TSingles.HideSingle3;
begin
...
procedure TSingles.HideSingle4;
begin
...
procedure TSingles.HideSingle5;
begin
...
procedure TSingles.HideSingle6;
begin
...
procedure TSingles.HideSingle7;
begin
...
procedure TSingles.HideSingle8;
begin
...
procedure TSingles.HideSingle9;
begin
...
procedure TSingles.HideSingle10;
begin
...
procedure TSingles.HideSingle11;
begin
...
procedure TSingles.HideSingle12;
begin
...
procedure TSingles.HideSingle13;
begin
  DBEdit25.Visible := False;
  DBEdit26.Visible := False;
  DBCheckBox25.Visible := False;
  DBCheckBox26.Visible := False;
end;
procedure TSingles.HideSingle14;
begin
  DBEdit27.Visible := False;
  DBEdit28.Visible := False;
  DBCheckBox27.Visible := False;
  DBCheckBox28.Visible := False;
end;
procedure TSingles.HideSingle15;
begin
  DBEdit29.Visible := False;
  DBEdit30.Visible := False;
  DBCheckBox29.Visible := False;
  DBCheckBox30.Visible := False;
end;

procedure TSingles.AssignHomePlayers;
...
procedure TSingles.DBEdit1DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
...
procedure TSingles.DBEdit1DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit1DblClick(Sender: TObject);
begin
  AddToList1(DBEdit1.Text);
  DBEdit1.Text := '';
...
// Player 2
procedure TSingles.DBEdit3DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox1.ItemIndex >= 0 then
...
procedure TSingles.DBEdit3DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit3DblClick(Sender: TObject);
begin
  AddToList1(DBEdit3.Text);
  DBEdit3.Text := '';
...
// Player 3
procedure TSingles.DBEdit5DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox1.ItemIndex >= 0 then
...
procedure TSingles.DBEdit5DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit5DblClick(Sender: TObject);
begin
  AddToList1(DBEdit5.Text);
  DBEdit5.Text := '';
...
// Player 4
procedure TSingles.DBEdit7DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox1.ItemIndex >= 0 then
...
procedure TSingles.DBEdit7DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit7DblClick(Sender: TObject);
begin
  AddToList1(DBEdit7.Text);
  DBEdit7.Text := '';
...
// Player 5
procedure TSingles.DBEdit9DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox1.ItemIndex >= 0 then
...
procedure TSingles.DBEdit9DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit9DblClick(Sender: TObject);
begin
  AddToList1(DBEdit9.Text);
  DBEdit9.Text := '';
...
// Player 6
procedure TSingles.DBEdit11DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox1.ItemIndex >= 0 then
...
procedure TSingles.DBEdit11DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit11DblClick(Sender: TObject);
begin
  AddToList1(DBEdit11.Text);
  DBEdit11.Text := '';
...
// Player 7
procedure TSingles.DBEdit13DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox1.ItemIndex >= 0 then
...
procedure TSingles.DBEdit13DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit13DblClick(Sender: TObject);
begin
  AddToList1(DBEdit13.Text);
  DBEdit13.Text := '';
...
// Player 8
procedure TSingles.DBEdit15DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox1.ItemIndex >= 0 then
...
procedure TSingles.DBEdit15DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit15DblClick(Sender: TObject);
begin
  AddToList1(DBEdit15.Text);
  DBEdit15.Text := '';
...
// Player 9
procedure TSingles.DBEdit17DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox1.ItemIndex >= 0 then
...
procedure TSingles.DBEdit17DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit17DblClick(Sender: TObject);
begin
  AddToList1(DBEdit17.Text);
  DBEdit17.Text := '';
...
// Player 10
procedure TSingles.DBEdit19DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox1.ItemIndex >= 0 then
...
procedure TSingles.DBEdit19DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit19DblClick(Sender: TObject);
begin
  AddToList1(DBEdit19.Text);
  DBEdit19.Text := '';
...
// Player 11
procedure TSingles.DBEdit21DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox1.ItemIndex >= 0 then
...
procedure TSingles.DBEdit21DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit21DblClick(Sender: TObject);
begin
  AddToList1(DBEdit21.Text);
  DBEdit21.Text := '';
...
// Player 12
procedure TSingles.DBEdit23DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox1.ItemIndex >= 0 then
...
procedure TSingles.DBEdit23DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit23DblClick(Sender: TObject);
begin
  AddToList1(DBEdit23.Text);
  DBEdit23.Text := '';
...
// Player 13
procedure TSingles.DBEdit25DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox1.ItemIndex >= 0 then
...
procedure TSingles.DBEdit25DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
  AddToList1(DBEdit25.Text);
  DBEdit25.Text := ListBox1.Items.Strings[ListBox1.ItemIndex];
  Single13HomePlayerName.Value := ListBox1.Items.Strings[ListBox1.ItemIndex];
  RemoveFromList1(DBEdit25.Text);
end;

procedure TSingles.DBEdit25DblClick(Sender: TObject);
begin
  AddToList1(DBEdit25.Text);
  DBEdit25.Text := '';
  Single13HomePlayerName.Value := '';
end;
// Player 14
procedure TSingles.DBEdit27DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox1.ItemIndex >= 0 then
...
procedure TSingles.DBEdit27DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
  AddToList1(DBEdit27.Text);
  DBEdit27.Text := ListBox1.Items.Strings[ListBox1.ItemIndex];
  Single14HomePlayerName.Value := ListBox1.Items.Strings[ListBox1.ItemIndex];
  RemoveFromList1(DBEdit27.Text);
end;

procedure TSingles.DBEdit27DblClick(Sender: TObject);
begin
  AddToList1(DBEdit27.Text);
  DBEdit27.Text := '';
  Single14HomePlayerName.Value := '';
end;
// Player 15
procedure TSingles.DBEdit29DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox1.ItemIndex >= 0 then
...
procedure TSingles.DBEdit29DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
  AddToList1(DBEdit29.Text);
  DBEdit29.Text := ListBox1.Items.Strings[ListBox1.ItemIndex];
  Single15HomePlayerName.Value := ListBox1.Items.Strings[ListBox1.ItemIndex];
  RemoveFromList1(DBEdit29.Text);
end;

procedure TSingles.DBEdit29DblClick(Sender: TObject);
begin
  AddToList1(DBEdit29.Text);
  DBEdit29.Text := '';
  Single15HomePlayerName.Value := '';
end;
// End of Home Player Drag and Drop

// List Box 1 Procedure Start Here
procedure TSingles.ListBox1Exit(Sender: TObject);
begin
ListBox1.ItemIndex := -1;
end;

procedure TSingles.ListBox1DblClick(Sender: TObject);
begin
  ...
  if LeagueQueryNoSingles.Value < 13 then abort;
  ...
  if LeagueQueryNoSingles.Value < 14 then abort;
  ...
  if LeagueQueryNoSingles.Value < 15 then abort;
...
procedure TSingles.DBEdit2DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
...
procedure TSingles.DBEdit2DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit2DblClick(Sender: TObject);
begin
  AddToList2(DBEdit2.Text);
  DBEdit2.Text := '';
...
// Player 2
procedure TSingles.DBEdit4DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox2.ItemIndex >= 0 then
...
procedure TSingles.DBEdit4DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit4DblClick(Sender: TObject);
begin
  AddToList2(DBEdit4.Text);
  DBEdit4.Text := '';
...
// Player 3
procedure TSingles.DBEdit6DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox2.ItemIndex >= 0 then
...
procedure TSingles.DBEdit6DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit6DblClick(Sender: TObject);
begin
  AddToList2(DBEdit6.Text);
  DBEdit6.Text := '';
...
// Player 4
procedure TSingles.DBEdit8DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox2.ItemIndex >= 0 then
...
procedure TSingles.DBEdit8DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit8DblClick(Sender: TObject);
begin
  AddToList2(DBEdit8.Text);
  DBEdit8.Text := '';
...
// Player 5
procedure TSingles.DBEdit10DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox2.ItemIndex >= 0 then
...
procedure TSingles.DBEdit10DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit10DblClick(Sender: TObject);
begin
  AddToList2(DBEdit10.Text);
  DBEdit10.Text := '';
...
// Player 6
procedure TSingles.DBEdit12DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox2.ItemIndex >= 0 then
...
procedure TSingles.DBEdit12DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit12DblClick(Sender: TObject);
begin
  AddToList2(DBEdit12.Text);
  DBEdit12.Text := '';
...
// Player 7
procedure TSingles.DBEdit14DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox2.ItemIndex >= 0 then
...
procedure TSingles.DBEdit14DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit14DblClick(Sender: TObject);
begin
  AddToList2(DBEdit14.Text);
  DBEdit14.Text := '';
...
// Player 8
procedure TSingles.DBEdit16DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox2.ItemIndex >= 0 then
...
procedure TSingles.DBEdit16DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit16DblClick(Sender: TObject);
begin
  AddToList2(DBEdit16.Text);
  DBEdit16.Text := '';
...
// Player 9
procedure TSingles.DBEdit18DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox2.ItemIndex >= 0 then
...
procedure TSingles.DBEdit18DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit18DblClick(Sender: TObject);
begin
  AddToList2(DBEdit18.Text);
  DBEdit18.Text := '';
...
// Player 10
procedure TSingles.DBEdit20DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox2.ItemIndex >= 0 then
...
procedure TSingles.DBEdit20DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit20DblClick(Sender: TObject);
begin
  AddToList2(DBEdit20.Text);
  DBEdit20.Text := '';
...
// Player 11
procedure TSingles.DBEdit22DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox2.ItemIndex >= 0 then
...
procedure TSingles.DBEdit22DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit22DblClick(Sender: TObject);
begin
  AddToList2(DBEdit22.Text);
  DBEdit22.Text := '';
...
// Player 12
procedure TSingles.DBEdit24DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox2.ItemIndex >= 0 then
...
procedure TSingles.DBEdit24DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
...
procedure TSingles.DBEdit24DblClick(Sender: TObject);
begin
  AddToList2(DBEdit24.Text);
  DBEdit24.Text := '';
...
// Player 13
procedure TSingles.DBEdit26DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox2.ItemIndex >= 0 then
...
procedure TSingles.DBEdit26DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
  AddToList2(DBEdit26.Text);
  DBEdit26.Text := ListBox2.Items.Strings[ListBox2.ItemIndex];
  Single13AwayPlayerName.Value := ListBox2.Items.Strings[ListBox2.ItemIndex];
  RemoveFromList2(DBEdit26.Text);
end;

procedure TSingles.DBEdit26DblClick(Sender: TObject);
begin
  AddToList2(DBEdit26.Text);
  DBEdit26.Text := '';
  Single13AwayPlayerName.Value := '';
end;
// Player 14
procedure TSingles.DBEdit28DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox2.ItemIndex >= 0 then
...
procedure TSingles.DBEdit28DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
  AddToList2(DBEdit28.Text);
  DBEdit28.Text := ListBox2.Items.Strings[ListBox2.ItemIndex];
  Single14AwayPlayerName.Value := ListBox2.Items.Strings[ListBox2.ItemIndex];
  RemoveFromList2(DBEdit28.Text);
end;

procedure TSingles.DBEdit28DblClick(Sender: TObject);
begin
  AddToList2(DBEdit28.Text);
  DBEdit28.Text := '';
  Single14AwayPlayerName.Value := '';
end;
// Player 15
procedure TSingles.DBEdit30DragOver(Sender, Source: TObject; X, Y: Integer;
  State: TDragState; var Accept: Boolean);
begin
  Accept := False;
  if ListBox2.ItemIndex >= 0 then
...
procedure TSingles.DBEdit30DragDrop(Sender, Source: TObject; X, Y: Integer);
begin
  AddToList2(DBEdit30.Text);
  DBEdit30.Text := ListBox2.Items.Strings[ListBox2.ItemIndex];
  Single15AwayPlayerName.Value := ListBox2.Items.Strings[ListBox2.ItemIndex];
  RemoveFromList2(DBEdit30.Text);
end;

procedure TSingles.DBEdit30DblClick(Sender: TObject);
begin
  AddToList2(DBEdit30.Text);
  DBEdit30.Text := '';
  Single15AwayPlayerName.Value := '';
end;
// End of Away Player Drag and Drop

procedure TSingles.BitBtn1Click(Sender: TObject);
begin
  if LeagueQueryNoSingles.Value > 0 then
    Single1.Post;
  if LeagueQueryNoSingles.Value > 1 then
...
procedure TSingles.SpeedButton1Click(Sender: TObject);
...
procedure TSingles.SpeedButton2Click(Sender: TObject);
var sendstring: String;
var i: Integer;
begin
  sendstring := awayteam;
...
procedure TSingles.ListBox2DblClick(Sender: TObject);
begin
  if LeagueQueryNoSingles.Value < 1 then abort;
...
procedure TSingles.ListBox2Exit(Sender: TObject);
begin
  ListBox2.ItemIndex := -1;
end;

procedure TSingles.BitBtn2Click(Sender: TObject);
begin
  Close;
end;
