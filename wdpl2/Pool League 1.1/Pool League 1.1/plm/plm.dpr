...
uses
  ...
  playerpurge in '..\plm modules\playerpurge.pas' {PPForm},
  license in '..\plm modules\license.pas' {LicForm};
...
// Add splash screen
  ...
  SplashForm.Show;
  SplashForm.Update;
  Application.HelpFile := 'C:\Data\My Documents\Personal\Projects\Pool League 1.1\plm\Plm.hlp';
  ...
  Application.CreateForm(TPPForm, PPForm);
  SplashForm.Hide;
  SplashForm.Free;
  Application.Run;
end.
