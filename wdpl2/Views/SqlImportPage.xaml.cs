...
public partial class SqlImportPage : ContentPage
{
    ...
    private async void OnPreviewClicked(object? sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                preview.AppendLine();
                preview.AppendLine($"🎱 Player Names: {_parsedData.Tables["tblplayers"].Count} players found");
            ...
            {
                preview.AppendLine();
                preview.AppendLine("⚠️ Note: No tblplayers data found.");
                preview.AppendLine("   Players will be created with placeholder names.");
            }

            preview.AppendLine();
            preview.AppendLine("✨ Import will skip duplicates automatically:");
            preview.AppendLine("   • Players with same name");
            preview.AppendLine("   • Fixtures with same date + teams");
            preview.AppendLine("   • Results for matches already played");
