...
public partial class BatchImportPreviewPage : ContentPage
{
    ...
    private void DisplayFiles()
    {
        ...
        if (_batchPreview.Files.Count > 50)
        {
            ...
            {
                Text = $"ℹ️ Showing first 50 of {_batchPreview.Files.Count} files.",
    ...
    private void ShowAlerts()
    {
        ...
        if (_aggregatedTeams.Count == 0 && _aggregatedPlayers.Count == 0)
        {
            ...
            AlertsStack.Children.Add(new Label
            {
                Text = "ℹ️ No league data detected in these files",
                TextColor = Colors.White,
                FontSize = 12,
        ...
        if (autoMerged > 0)
        {
            AlertsStack.Children.Add(new Label
            {
                Text = $"ℹ️ {autoMerged} player(s) auto-merged due to similar names",
        ...
        if (pendingMerges.Count != 0)
        {
            ...
            AlertsStack.Children.Add(new Label
            {
                Text = $"ℹ️ {pendingMerges.Count} potential duplicate player(s) found:",
